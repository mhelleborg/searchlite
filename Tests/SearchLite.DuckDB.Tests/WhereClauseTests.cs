...
public class WhereClauseTests
{
    ...
    public void Should_Handle_Simple_Integer_Comparison()
    {
        ...
        clause.Sql.Should().Be("CAST(json_extract(document, '$.Age') AS BIGINT) > $p0");
    ...
    public void Should_Handle_Enum_Comparison()
    {
        ...
        clause.Sql.Should().Be("CAST(json_extract(document, '$.EnumValue') AS BIGINT) = $p0");
        clause.Parameters.Should().HaveCount(1);
    ...
    public void Should_Handle_String_Enum_Comparison()
    {
        ...
        clause.Sql.Should().Be("json_extract_string(document, '$.StringEnumValue') = $p0");
        clause.Parameters.Should().HaveCount(1);
    ...
    public void Should_Handle_String_Equality()
    {
        ...
        clause.Sql.Should().Be("json_extract_string(document, '$.Name') = $p0");
        clause.Parameters.Should().HaveCount(1);
    ...
    public void Should_Handle_Boolean_Comparison()
    {
        ...
        clause.Sql.Should().Be("CAST(json_extract(document, '$.IsActive') AS BOOLEAN) = $p0");
        clause.Parameters.Should().HaveCount(1);
    ...
    public void Should_Handle_Double_Comparison()
    {
        ...
        clause.Sql.Should().Be("CAST(json_extract(document, '$.Score') AS DOUBLE) >= $p0");
        clause.Parameters.Should().HaveCount(1);
    ...
    public void Should_Handle_Decimal_Comparison()
    {
        ...
        clause.Sql.Should().Be("CAST(json_extract(document, '$.Price') AS DOUBLE) < $p0");
        clause.Parameters.Should().HaveCount(1);
    ...
    public void Should_Handle_DateTime_Comparison()
    {
        ...
        clause.Sql.Should().Be("json_extract_string(document, '$.CreatedAt') > $p0");
        clause.Parameters.Should().HaveCount(1);
    ...
    public void Should_Handle_Multiple_Conditions_With_And()
    {
        ...
        clause.Sql.Should()
            .Be(
                "(CAST(json_extract(document, '$.Age') AS BIGINT) > $p0 AND CAST(json_extract(document, '$.IsActive') AS BOOLEAN) = $p1)");
    ...
    public void Should_Handle_Multiple_Conditions_With_Or()
    {
        ...
        clause.Sql.Should()
            .Be(
                "(json_extract_string(document, '$.Name') = $p0 OR json_extract_string(document, '$.Name') = $p1)");
        clause.Parameters.Should().HaveCount(2);
        clause.Parameters[0].Value.Should().Be("John");
    ...
    public void Should_Handle_Complex_Nested_Conditions()
    {
        ...
        clause.Sql.Should().Be(
            "((CAST(json_extract(document, '$.Age') AS BIGINT) > $p0 AND CAST(json_extract(document, '$.IsActive') AS BOOLEAN) = $p1) OR " +
            "(CAST(json_extract(document, '$.Score') AS DOUBLE) >= $p2 AND json_extract_string(document, '$.Name') = $p3))");
    ...
    public void Should_Handle_Multiple_Predicates()
    {
        ...
        clauses[0].Sql.Should().Be("CAST(json_extract(document, '$.Age') AS BIGINT) > $p0");
        clauses[1].Sql.Should().Be("CAST(json_extract(document, '$.IsActive') AS BOOLEAN) = $p0");
    ...
    public void Should_Handle_All_Comparison_Operators()
    {
        ...
        [
            (x => x.Age == 18, "CAST(json_extract(document, '$.Age') AS BIGINT) = $p0"),
            (x => x.Age != 18, "CAST(json_extract(document, '$.Age') AS BIGINT) != $p0"),
            (x => x.Age > 18, "CAST(json_extract(document, '$.Age') AS BIGINT) > $p0"),
            (x => x.Age >= 18, "CAST(json_extract(document, '$.Age') AS BIGINT) >= $p0"),
            (x => x.Age < 18, "CAST(json_extract(document, '$.Age') AS BIGINT) < $p0"),
    ...
    public void Should_Handle_Nested_String_Equality()
    {
        ...
        clause.Sql.Should().Be("json_extract_string(document, '$.Author.Name') = $p0");
        clause.Parameters.Should().HaveCount(1);
        clause.Parameters[0].Value.Should().Be("John");
    }
    ...
    public void Should_Handle_Nested_Integer_Comparison()
    {
        ...
        clause.Sql.Should().Be("CAST(json_extract(document, '$.Author.Age') AS BIGINT) > $p0");
        clause.Parameters.Should().HaveCount(1);
        clause.Parameters[0].Value.Should().Be(18);
    }
    ...
    public void Should_Handle_Deeply_Nested_String_Equality()
    {
        ...
        clause.Sql.Should().Be("json_extract_string(document, '$.Author.Address.City') = $p0");
        clause.Parameters.Should().HaveCount(1);
    ...
    public void Should_Handle_Nested_Null_Check()
    {
        ...
        clause.Sql.Should().Be("(json_extract(document, '$.Author.Name') IS NULL OR json_extract(document, '$.Author.Name') = 'null')");
    ...
    public void Should_Handle_Nested_String_Operator()
    {
        ...
        clause.Sql.Should().Be("json_extract_string(document, '$.Author.Name') LIKE $p0 ESCAPE '\\'");
        clause.Parameters.Should().HaveCount(1);
    ...
    public void Should_Handle_CollectionContains()
    {
        ...
        clause.Sql.Should().Be(
            "(json_extract(document, '$.Labels') IS NOT NULL AND list_contains(CAST(json_extract(document, '$.Labels') AS VARCHAR[]), $p0))");
        clause.Parameters.Should().HaveCount(1);
    ...
    public void Should_Handle_CollectionNotContains()
    {
        ...
        clause.Sql.Should().Be(
            "NOT (json_extract(document, '$.Labels') IS NOT NULL AND list_contains(CAST(json_extract(document, '$.Labels') AS VARCHAR[]), $p0))");
        clause.Parameters.Should().HaveCount(1);
        clause.Parameters[0].Value.Should().Be("urgent");
    }
    ...
    public void Should_Handle_Nested_CollectionContains()
    {
        ...
        clause.Sql.Should().Be(
            "(json_extract(document, '$.Author.Roles') IS NOT NULL AND list_contains(CAST(json_extract(document, '$.Author.Roles') AS VARCHAR[]), $p0))");
        clause.Parameters.Should().HaveCount(1);
